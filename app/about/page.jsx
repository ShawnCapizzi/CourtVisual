...
const FAQ = [
  ...
  },
  {
    ...
    a: "CourtVisual runs on a proprietary blend of live data from multiple trusted feeds, covering schedules, tickets, broadcast details, and matchup projections across pro teams and national competitions. The watch guides are kept current by hand and checked each season. The rivalry catalog and the scoring itself are ours, the part you won\u2019t find anywhere else.",
    aNode: (
      <>
        CourtVisual runs on a <strong>proprietary blend of live data from multiple trusted feeds</strong>, covering schedules, tickets, broadcast details, and matchup projections across pro teams and national competitions. The watch guides are kept current by hand and checked each season. <strong>The rivalry catalog and the scoring itself are ours</strong>, the part you won&rsquo;t find anywhere else.
      </>
    ),
  },
  {
  ...
  return (
    <main className="g-ui" style={stage}>
      ...
      <div style={{ ...wrap, position: "relative", zIndex: 1 }}>
        ...
        <p style={sub}>
          <strong>Independent product.</strong> Live data comes from a proprietary blend of multiple trusted feeds. <strong>The rivalry catalog and scoring engine are CourtVisual&rsquo;s own.</strong>
        </p>
