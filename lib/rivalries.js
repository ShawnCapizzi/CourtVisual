...
const PAIRS = [
  ...
  ["magic","heat",3,0],["hornets","hawks",2,0],["blazers","lakers",3,0],["raptors","celtics",3,0],["raptors","76ers",3,0],
  // NHL
  ...
  // NHL — Canadian + cross-border additions (Battle of Alberta/Ontario, Original Six)
  ["flames","oilers",5,"Battle of Alberta"],["senators","mapleleafs",4,"Battle of Ontario"],
  ["canadiens","mapleleafs",5,0],["canadiens","senators",3,0],["mapleleafs","sabres",3,0],
  ["mapleleafs","lightning",3,0],["mapleleafs","redwings",3,0],["flames","canucks",3,0],
  ["oilers","canucks",3,0],["oilers","kings",4,0],["senators","sabres",2,0],
  ["jets","predators",4,0],["jets","wild",3,0],["bruins","panthers",3,0],["rangers","penguins",4,0],["rangers","capitals",3,0],
  // MLS
  ...
  ["tempo","fire",2,0],["tempo","liberty",2,0],
];
