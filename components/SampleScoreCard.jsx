  ...
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
      <defs>
        ...
        <radialGradient id="scRingWellDark" cx="50%" cy="40%" r="62%">
          <stop offset="0%" stopColor="#13151A" /><stop offset="58%" stopColor="#0D0E12" /><stop offset="100%" stopColor="#07080B" />
        </radialGradient>
        <pattern id="scRingWeave" patternUnits="userSpaceOnUse" width="5.5" height="5.5">
      ...
      <circle cx={c} cy={c} r={R - size * (2.75 / 66)} fill={big ? "url(#scRingWellDark)" : "url(#scRingWell)"} />
      <circle cx={c} cy={c} r={R - size * (2.75 / 66)} fill="url(#scRingWeave)" />
